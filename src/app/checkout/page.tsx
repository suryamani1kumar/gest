      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-12">
          <div className="lg:w-2/3 space-y-10">
            ...
            <button
              type="button"
              className="w-full bg-[#7A1F1F] text-white p-5 uppercase tracking-widest text-sm font-medium hover:bg-[#B8860B] transition-colors mt-8 rounded-lg cursor-pointer"
